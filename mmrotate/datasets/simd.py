...
class SIMDDataset(BaseDataset):
    """SIMD dataset for detection.
    ...
    METAINFO = {
        'classes':
        ('car', 'truck', 'van', 'longvehicle', 'bus',
         'airliner', 'propeller', 'trainer',
         'chartered', 'fighter', 'other', 'stairtruck', 'pushbacktruck', 'helicopter',
         'boat'),
        
        'palette': [(150, 30, 150), (119, 11, 32), (0, 0, 142), (0, 0, 230),
